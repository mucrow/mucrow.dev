...
export default function Services() {
  return (
    <Article>
      ...
      <h3>Unity Game Development in C#</h3>
      <ul>
      ...
      <h3>React Web Development in TypeScript and JavaScript</h3>
      <ul>
      ...
      <h3>Video Game Music Production</h3>
      <ul>
      ...
      <p>To inquire about commissions, please <a href="https://example.com" target="_blank">send me an email</a>, <a href="https://example.com" target="_blank">add me as a friend on Discord</a>, or <a href="https://example.com" target="_blank">direct message me on Twitter</a>.</p>
